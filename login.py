...
class Login_Window:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\login_system\images\2808854.jpg")
        ...
        frameadmin=Frame(self.root,bg="black")
        frameadmin.place(x=510,y=170,width=340,height=450)

        img1=Image.open(r"C:\Hotel Management System\images\login2.png")
        img1=img1.resize((100,100),Image.ANTIALIAS)
        self.PhotoImage1=ImageTk.PhotoImage(img1)
        lblimg1=Label(image=self.PhotoImage1,bg="black",borderwidth=0)
        lblimg1.place(x=630,y=175,width=100,height=100)

        get_str=Label(frameadmin,text="Admin Login",font=("times new roman",20,"bold"),fg="white",bg="black")
        get_str.place(x=95,y=100)

        #label
        username=lbl=Label(frameadmin,text="Username",font=("times new roman",15,"bold"),fg="white",bg="black")
        username.place(x=70,y=155)

        self.txtAduser=ttk.Entry(frameadmin,font=("times new roman",15,"bold"))
        self.txtAduser.place(x=40,y=180,width=270)

        password=lbl=Label(frameadmin,text="Password",font=("times new roman",15,"bold"),fg="white",bg="black")
        password.place(x=70,y=225)

        self.txtAdpass=ttk.Entry(frameadmin,show="*",font=("times new roman",15,"bold"))
        self.txtAdpass.place(x=40,y=250,width=270)
        ...
        #LOGIN BUTTON==
        loginadminbtn=Button(frameadmin,command=self.admin_login,text="Login",font=("times new roman",15,"bold"),bd=3,relief=RIDGE,fg="white",bg="#007bff",activeforeground="white",activebackground="#007bff")
        loginadminbtn.place(x=110,y=300,width=120,height=35)

    def admin_login(self):
        
        if self.txtAduser.get()=="" or self.txtAdpass.get()=="":
            messagebox.showerror("Error"," All fields are required !") 

        elif self.txtAduser.get()!="admin" and self.txtAdpass.get()!="admin1":
            messagebox.showerror("Error","Invalid Username and Password")
        elif self.txtAduser.get()=="admin" and self.txtAdpass.get()=="admin1":
            messagebox.showinfo("Success","Welcome To User Login")
        ...
        #LOGIN BUTTON==
            loginbtn=Button(frame,text="Login",command=self.login_user,font=("times new roman",15,"bold"),bd=3,relief=RIDGE,fg="white",bg="#007bff",activeforeground="white",activebackground="#007bff")
        ...
        #forget pass button==
            forgetpassbtn=Button(frame,command=self.forgot_password_window,text="Forget Password",font=("times new roman",10,"bold"),borderwidth=0,fg="white",bg="black",activeforeground="white",activebackground="#007bff")
    ...
    def login_user(self):
        if self.txtuser.get()=="" or self.txtpass.get()=="":
            ...
            messagebox.showinfo("Success","Welcome to Win Hotel")
            ...
            if row==None:
                ...
                open_main=messagebox.askyesno("YesNo","Access by User")
                if open_main>0:
                    self.new_window=Toplevel(self.root)
